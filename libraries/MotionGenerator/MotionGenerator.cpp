...
uint32_t MotionGenerator::getLegsPos(uint8_t legid)
{
    if (legid < 10)
    {
        return 2048 + (int32_t)(qd_legs[0].v_theta[legid - 1] / 0.088f);
    }
    else if (legid < 20)
    {
        return 2048 + (int32_t)(qd_legs[1].v_theta[legid - 11] / 0.088f);
    }
    else if (legid < 30)
    {
        return 2048 + (int32_t)(qd_legs[2].v_theta[legid - 21] / 0.088f);
    }
    else if (legid < 40)
    {
        return 2048 + (int32_t)(qd_legs[3].v_theta[legid - 31] / 0.088f);
    }
    else
    {
        return 2048;
